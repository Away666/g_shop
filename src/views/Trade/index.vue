  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="order.imgUrl" alt="" style="height: 82px; width: 82px" />
          </li>
          <li>
            <p>
              {{ order.skuName }}
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let params = {
        ...
        deliveryAddress: this.changeDefault.fullAddress,
        paymentWay: "ONLINE",
        orderComment: this.msg,
        orderDetailList: this.orderInfo.detailArrayList,
      };
      let { data } = await this.$api.reqSubmitOrder(tradeNo, params);
      if (data.code == 200) {
